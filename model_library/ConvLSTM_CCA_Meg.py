...
class Model(tf.keras.Model):
    ...
    def call(self, image_sequences, path_sequences, feature, training):
        ...
        # LSTM block for path prediction
        lstm_output = self.lstm_layer(path_sequences, training=training)
